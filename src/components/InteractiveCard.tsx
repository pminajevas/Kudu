...
export default function InteractiveCard({ children, className = "" }: InteractiveCardProps) {
  ...
  return (
    <div className={`relative overflow-hidden cursor-magic ${className}`} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} onMouseMove={handleMouseMove}>
