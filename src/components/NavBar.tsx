...
export default function NavBar() {
  ...
  return (
    <header className="flex items-center justify-between sticky top-0 left-0 w-full px-4 sm:px-8 py-4 z-50 bg-gradient-to-r from-[var(--background)]/80 via-[#FFF9F5]/80 to-[#FFFDF8]/80 backdrop-blur-sm border-b border-[var(--primary)] border-opacity-10 animate-fadeInUp">
